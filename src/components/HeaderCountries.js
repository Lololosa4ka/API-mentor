...
function HeaderCountries(props) {
    const changeDataTheme = () => {
        const page = document.getElementById("app");
        const dataTheme = page.getAttribute("data-theme");
        if (dataTheme === "dark") {
